...
bot.on('conversationUpdate', (message) => {
    if (message.membersAdded) {
        const hello = new builder.Message()
            ...
            .text("Welcome to Asisstant translation bot. I will help you translate your messages from one language to another. Simply select your languages and write me.");
        bot.send(hello);
    }
});
